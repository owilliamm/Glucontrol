...
Em *Data e Hora*, sua resposta deve ser escrita no formato (DD/MM/YYYY HH:MM), **incluindo as barras (/) e o dois pontos (:).** Se sua entrada não for neste formato, o programa indica o erro e solicita os dados novamente.
